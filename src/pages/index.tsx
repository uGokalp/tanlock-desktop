...
import { useDeviceGroups, useDevicesInGroups } from "@/hooks/db/useDeviceGroups"
...
const Home: NextPage = () => {
  ...
  const devicesInGroups = useDevicesInGroups()
      ...
      <div className="w-full rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
        <div className="sm:hidden">
          ...
          >
            ...
            <option>Device Statistics</option>
          </select>
        </div>
        {/* User */}
        <ul
        ...
        >
          ...
          >
            <dl className="mx-auto grid max-w-screen-xl grid-cols-3 gap-8 p-4 text-gray-900 dark:text-white sm:p-8">
